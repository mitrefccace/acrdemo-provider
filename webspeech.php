...
function wsSend(str)
{
   ...
   {
      ws = new WebSocket('<?php echo $config["websocketurl"];?>',"echo-protocol");
      ws.onopen = function()
      {
         ws.send(str);
      };
      ...
      {
        $('#statusmsg').text('WebSocket destination not configured.');
      };
   }
   else
   {
...
<h1 class="center" id="headline">
  ...
  <p id="power_by">Powered by Google STT</p>
<div class="center">
</div>
<div id="info">
...
<h1 class="center" id="duplicate_text">
  <a href="http://dvcs.w3.org/hg/speech-api/raw-file/tip/speechapi.html">
    Receiver Output: </a></h1>
<div id="duplicates">
  <span id="duplicate_final_span" class="duplicate_final"></span>
  <span id="duplicate_interim_span" class="duplicate_interim"></span>
  <p>
</div>
<div class="center">
...
<div style="margin-left:20px;font-size:14px;font-weight:bold;color:blue;" id="statusmsg"></div>
<script>
var langs =
[['Afrikaans',       ['af-ZA']],
